...
using Kpi.MetaUa.ClientTests.Model.Platform.Client;
using Kpi.MetaUa.ClientTests.Model.Platform.Communication;
using Kpi.MetaUa.ClientTests.Platform.Communication.Http;
using RestSharp;
using Serilog;

namespace Kpi.MetaUa.ClientTests.Platform.Client
{
