...
using Kpi.MetaUa.ClientTests.Platform.Enum;
using OpenQA.Selenium;
using OpenQA.Selenium.Chrome;
using OpenQA.Selenium.Remote;
using Serilog;
using IJavaScriptExecutor = Kpi.MetaUa.ClientTests.Model.Platform.Drivers.IJavaScriptExecutor;
...
namespace Kpi.MetaUa.ClientTests.Platform.Driver
{
    public sealed class WebDriver : Model.Platform.Drivers.IWebDriver, IJavaScriptExecutor, INative
    {
        ...
        public void SwitchToNewTab() =>
            _nativeDriver.SwitchTo().Window(_nativeDriver.WindowHandles.Last());
        ...
        private ChromeOptions GetChromeOptions()
        {
            ...
            options.AddArgument(
                "--user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.186 Safari/537.36 FGE5GDWER1XZOPIMLW8OE");
